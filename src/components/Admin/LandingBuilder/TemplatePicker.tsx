...
interface TemplatePickerProps {
  templates?: LandingTemplateDefinition[];
  selectedId?: string;
  onSelect: (template: LandingTemplateDefinition) => void;
}

export default function TemplatePicker({ templates = LANDING_TEMPLATES, selectedId, onSelect }: TemplatePickerProps) {
  return <div className="grid max-h-[55vh] gap-3 overflow-y-auto pr-1 sm:grid-cols-2">{templates.map((template) => {
